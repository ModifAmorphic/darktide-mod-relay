...
- **Mod loader Lua tests** are an offline LuaJIT harness — no game, no wine.
  ...
  request seam, exact LEFT Ctrl+Shift+R parity, teardown-frame +
  one-entry-per-tick replacement-replay ordering, reload-data keying,
