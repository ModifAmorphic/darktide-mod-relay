...
- **`RELAY_MOD_PATH`** (from `--mod-path` / `RELAY_MOD_PATH`) —
  **user-controlled**. The **mod path**: a directory that *contains*
  ...
  there and passes absolute paths through verbatim — no containment).
