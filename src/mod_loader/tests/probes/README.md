...
- **Relay shell log** is `relay.log`. By default (`--log-lua` off) **neither**
  ...
  [`observational/log_lua_probe/README.md`](observational/log_lua_probe/README.md).
